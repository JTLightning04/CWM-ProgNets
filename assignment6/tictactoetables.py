        ...
        if valid == 1:
            ...
            try:
                pkt = Ether(dst='00:04:00:00:00:00', type=0x1234) / P4calc(op='+',
                                                  operand_a=int(str(place_a)+str(place_b)+str(place_c)+str(place_d)+str(place_e)+str(place_f)+str(place_g)+str(place_h)+str(place_i)))
